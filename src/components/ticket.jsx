...
const showData = async()=> {
    apiData = await axios.get("https://coednssecurity.in/healthmediator/ticket", {   
    }).then((response) => {
  ...
  return (
    <div className="textcontainer">
            <div className="section-title text-center">
                 <h2 style={{color:"#fff"}}>NameServers used by popular Travel and Transportation Booking Apps</h2>
