...
const showData = async()=> {
    apiData = await axios.get("https://coednssecurity.in/healthmediator/world25", {   
    }).then((response) => {
        //console.log(response.data);
        if (response.status == 200 && Object.keys(response.data).length !== 0) {
          return response.data.healthindexind;
        }
        else {
          return {};
        }    
  ...
  return (
    <div className="textcontainer">
            <div className="section-title text-center">
                 <h2 style={{color:"#fff"}}>Health of Top Nameservers accessed across World</h2>
