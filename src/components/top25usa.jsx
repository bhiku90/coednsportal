...
const showData = async()=> {
    apiData = await axios.get("https://coednssecurity.in/healthmediator/top25usa", {   
    }).then((response) => {
  ...
  return (
    <div className="textcontainer">
            <div className="section-title text-center">
                 <h2 style={{color:"#fff"}}>Health of Top Nameservers accessed from USA</h2>
