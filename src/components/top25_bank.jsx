...
const showData = async()=> {
    apiData = await axios.get("https://coednssecurity.in/healthmediator/top25bank", {   
    }).then((response) => {
  ...
  return (
    <div className="textcontainer">
            <div className="section-title text-center">
                 <h2 style={{color:"#fff"}}>NameServers used by popular Banking Websites</h2>
